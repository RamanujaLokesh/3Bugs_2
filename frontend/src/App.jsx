...
function App() {
  ...
  return (
    <div>
      ...
      <Route path='/complaint' element={!authUser || authUser?.auth_level >1?<Navigate to='/login' />:<ComplaintPage/>} />
      <Route path='/complaints' element={!authUser ||authUser?.auth_level===1?<Navigate to='/login' />:<Complaints/>} />
